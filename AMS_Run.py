...
window = tk.Tk()
window.title("AI POWERED SMART ATTENDANCE SYSTEM")
...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            ENR = tk.Label(MFW, text="Enter Enrollment", width=15, height=2, fg="black", bg="navajo white",
                           font=('times', 15))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Student name", width=15, height=2, fg="black", bg="navajo white",
                                font=('times', 15))
            ...
            def enter_data_DB():
                ...
                def create_csv():
                    global subb
                    subb = SUB_ENTRY.get()
                    csv_name = 'C:/Users/tijur/Downloads/Apna Project/Attendace_management_systemAttendance/Manually Attendance/' + subb + '.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\tijur\Downloads\Apna Project\Attendace_management_system\Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                cs = f'C:/Users/tijur/Downloads/Apna Project/Attendace_management_system/{fileName}'
    ...
    def Attf():
        os.startfile(r'C:\Users\tijur\Downloads\Apna Project\Attendace_management_system\Attendance')
    ...
    sub = tk.Label(windo, text="Enter Subject : ", width=15, height=2,
                   fg="black", bg="#8B4513", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'Artificial':
            if password == 'Artificial123':
                win.destroy()
                import csv
                import tkinter
                root = tkinter.Tk()
                ...
                cs = 'C:/Users/tijur/Downloads/Apna Project/Attendace_management_system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="AI POWERED SMART ATTENDANCE SYSTEM", bg="#008B8B", fg="white", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment : ", width=20, height=2,
               fg="white", bg="#8B4513", font=('times', 15, 'bold'))  # Brown background
...
lbl2 = tk.Label(window, text="Enter Name : ", width=20, fg="white",
                bg="#8B4513", height=2, font=('times', 15, ' bold '))  # Brown background
...
takeImg = tk.Button(window, text="Take Images", command=take_img, fg="black", bg="#4682B4",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)
trainImg = tk.Button(window, text="Train Images", fg="black", command=trainimg, bg="#4682B4",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)
FA = tk.Button(window, text="Automatic Attendance", fg="black", command=subjectchoose,
               bg="#4682B4", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
